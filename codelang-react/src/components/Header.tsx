  ...
  return (
    <header className="header">
      ...
      <div className="header-right">
        ...
        <div className='header-right-ln'>
          <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M5 8l6 6" />
